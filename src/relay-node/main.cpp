...
int main(int ac, char* av[])
{
    ...
    desc.add_options()
        ("name", po::value<std::string>()->required(), "name of this node")
    ...
    auto node = el.make_event_listener<Node>(vm["name"].as<std::string>(), vm["config"].as<std::string>(), vm["wait"].as<uint32_t>());
